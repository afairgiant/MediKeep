...
const MantinePractitionerForm = ({
  ...
  const specialtyOptions = [
    {
      value: 'Cardiology',
      label: '❤️ Cardiology - Heart & cardiovascular system',
    },
    ...
    { value: 'Oncology', label: '🎗️ Oncology - Cancer treatment' },
    ...
    { value: 'Endocrinology', label: '⚖️ Endocrinology - Hormones & glands' },
    {
      value: 'Rheumatology',
