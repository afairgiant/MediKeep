...
const VALID_MODES = new Set(['cards', 'table', 'components', 'stacked']);
...
/**
 * Persists a page-specific view mode ('cards', 'table', 'components', or 'stacked') in localStorage.
 *
 ...
 * @param {'cards' | 'table' | 'components' | 'stacked'} [defaultMode='cards'] - Fallback when nothing is stored.
 * @returns {['cards' | 'table' | 'components' | 'stacked', (mode: 'cards' | 'table' | 'components' | 'stacked') => void]}
 */
