...
jest.mock('../utils/activityNavigation', () => ({
  getActivityNavigationUrl: jest.fn(),
  getActivityIcon: jest.fn(),
  getActionBadgeColor: jest.fn(),
  getActionIcon: jest.fn(),
  formatActivityDescription: jest.fn(),
  isActivityClickable: jest.fn(),
  getActivityTooltip: jest.fn(),
}));
