...
export const familyMemberFormFields = [
  {
    name: 'name',
    type: 'text',
    labelKey: 'medical:familyHistory.form.member.name.label',
  ...
  },
  {
    ...
    placeholderKey: 'medical:familyHistory.form.member.relationship.placeholder',
    required: true,
  ...
  },
  {
    ...
    placeholderKey: 'medical:familyHistory.form.member.gender.placeholder',
