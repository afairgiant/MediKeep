...
class ActivityLog(Base):
    ...
    # Activity details
    action = Column(String, nullable=False)  # 'created', 'updated', 'deleted', 'viewed', 'downloaded'
    entity_type = Column(String, nullable=False)  # 'patient', 'medication', 'lab_result', 'condition', etc.
...
class ActionType:
    ...
    def get_all_actions(cls) -> list:
        ...
        return [
            cls.CREATED, cls.UPDATED, cls.DELETED, cls.VIEWED,
            cls.UPLOADED, cls.DOWNLOADED,
            cls.LOGIN, cls.LOGOUT,
            cls.ACTIVATED, cls.DEACTIVATED, cls.COMPLETED, cls.CANCELLED,
            cls.BACKUP_CREATED, cls.MAINTENANCE_STARTED, cls.MAINTENANCE_COMPLETED
        ]
...
class ActivityCategory:
    ...
    def get_medical_activities(cls) -> list:
        ...
        return [
            cls.PATIENT_CREATED, cls.PATIENT_UPDATED, cls.PATIENT_VIEWED, cls.PATIENT_DELETED,
            cls.MEDICATION_ADDED, cls.MEDICATION_UPDATED, cls.MEDICATION_DELETED,
            cls.LAB_RESULT_CREATED, cls.LAB_RESULT_UPDATED, cls.LAB_RESULT_VIEWED, cls.LAB_RESULT_DELETED,
            cls.LAB_FILE_UPLOADED, cls.LAB_FILE_DOWNLOADED, cls.LAB_FILE_DELETED,
            cls.CONDITION_ADDED, cls.CONDITION_UPDATED, cls.CONDITION_DELETED,
            cls.TREATMENT_STARTED, cls.TREATMENT_UPDATED, cls.TREATMENT_COMPLETED, cls.TREATMENT_DELETED,
            cls.IMMUNIZATION_ADDED, cls.IMMUNIZATION_UPDATED, cls.IMMUNIZATION_DELETED,
            cls.ALLERGY_ADDED, cls.ALLERGY_UPDATED, cls.ALLERGY_DELETED,
            cls.PROCEDURE_ADDED, cls.PROCEDURE_UPDATED, cls.PROCEDURE_DELETED,
            cls.ENCOUNTER_ADDED, cls.ENCOUNTER_UPDATED, cls.ENCOUNTER_DELETED,
        ]
    ...
    def get_admin_activities(cls) -> list:
        ...
        return [
            cls.ADMIN_ACCESS, cls.BACKUP_CREATED, cls.SYSTEM_MAINTENANCE, cls.BULK_OPERATION
        ]
    ...
    def get_user_activities(cls) -> list:
        ...
        return [
            cls.USER_LOGIN, cls.USER_LOGOUT, cls.USER_REGISTERED, cls.PASSWORD_CHANGED
        ]
...
class ActivityPriority:
    ...
    def get_priority_for_action(cls, action: str, entity_type: str) -> str:
        ...
        if action in [ActionType.LOGIN, ActionType.LOGOUT] and entity_type == EntityType.USER:
            return cls.HIGH
