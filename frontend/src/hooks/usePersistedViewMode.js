...
const VALID_MODES = new Set(['cards', 'table', 'matrix']);
...
/**
 * Persists a page-specific view mode ('cards', 'table', or 'matrix') in localStorage.
 *
 ...
 * @param {'cards' | 'table' | 'matrix'} [defaultMode='cards'] - Fallback when nothing is stored.
 * @returns {['cards' | 'table' | 'matrix', (mode: 'cards' | 'table' | 'matrix') => void]}
 */
