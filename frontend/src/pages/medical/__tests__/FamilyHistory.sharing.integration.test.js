...
const mockFamilyHistoryApi = {
  ...
  getSharedFamilyHistory: jest.fn(),
...
jest.mock('../../../utils/medicalPageConfigs', () => ({
...
jest.mock('../../../utils/tableFormatters', () => ({
  getEntityFormatters: () => ({}),
}));

jest.mock('../../../utils/linkNavigation', () => ({
  navigateToEntity: jest.fn(),
}));

// Mock child components
jest.mock('../../../components/invitations', () => ({
...
jest.mock('../../../components/medical/FamilyHistorySharingModal', () => {
...
jest.mock('../../../components/medical/MantineFamilyMemberForm', () => {
...
jest.mock('../../../components/medical/MantineFamilyConditionForm', () => {
...
jest.mock('../../../components/medical/StatusBadge', () => {
